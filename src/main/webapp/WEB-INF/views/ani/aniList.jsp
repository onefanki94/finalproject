    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <body>
            <div class="container">
                ...
                <label for="check-btn">
                    <img src="../../../img/main_img/list1.png" style="width: 60px; height: 60px; color: white; border : 1px solid gray;">
                </label>
                <ul class="menubars">
                    <li>
                            ...
                            <div>
                                <div class="div_li"
                                    ...
                                    <div class="list_img_bg" style="cursor: pointer;"><img
                                            src="https://ah9szoaj9w.ecn.cdn.ofs.kr/images/tvee-admin/content/CS_20240905151009.png"
                                            style="width: 274.267px; height: 368.301px;"></div>
                        ...
                        <div style="display: inline-block;">
                            <div>
                                <div class="div_li"
                                    style="transition: 0.4s; text-align: center; transform-origin: center center; display: inline-block; width: 274.267px;">
                                    <div class="list_img_bg" style="cursor: pointer;"><img
                                            src="https://ah9szoaj9w.ecn.cdn.ofs.kr/images/tvee-admin/content/CS_20240823163331.png"
                                            style="width: 274.267px; height: 368.301px;"></div>
                        ...
                        <div style="display: inline-block;">
                            <div>
                                <div class="div_li"
                                    style="transition: 0.4s; text-align: center; transform-origin: center center; display: inline-block; width: 274.267px;">
                                    <div class="list_img_bg" style="cursor: pointer;"><img
                                            src="https://ah9szoaj9w.ecn.cdn.ofs.kr/images/tvee-admin/content/CS_20240731170432.png"
                                            style="width: 274.267px; height: 368.301px;"></div>
                        ...
                        <div style="display: inline-block;">
                            <div>
                                <div class="div_li"
                                    style="transition: 0.4s; text-align: center; transform-origin: center center; display: inline-block; width: 274.267px;">
                                    <div class="list_img_bg" style="cursor: pointer;"><img
                                            src="https://ah9szoaj9w.ecn.cdn.ofs.kr/images/tvee-admin/content/CS_20240912180655.png"
                                            style="width: 274.267px; height: 368.301px;"></div>
                        ...
                        <div style="display: inline-block;">
                            <div>
                                <div class="div_li"
                                    style="transition: 0.4s; text-align: center; transform-origin: center center; display: inline-block; width: 274.267px;">
                                    <div class="list_img_bg" style="cursor: pointer;"><img
                                            src="https://ah9szoaj9w.ecn.cdn.ofs.kr/images/tvee-admin/content/CS_20240724113021.png"
                                            style="width: 274.267px; height: 368.301px;"></div>
                                    <p style="padding-bottom: 15px; white-space: normal; overflow-wrap: break-word;">
                                        키즈모노가타리 -코요미 뱀프-
                                    </p>
                        ...
                        <div style="display: inline-block;">
                            <div>
                                <div class="div_li"
                                    style="transition: 0.4s; text-align: center; transform-origin: center center; display: inline-block; width: 274.267px;">
                                    <div class="list_img_bg" style="cursor: pointer;"><img
                                            src="https://ah9szoaj9w.ecn.cdn.ofs.kr/images/tvee-admin/content/CS_20240806172406.jpg"
                                            style="width: 274.267px; height: 368.301px;"></div>
                    ...
                    <div>
                        <div class="div_li"
                            ...
                            <div class="list_img_bg" style="cursor: pointer;"><img
                                    src="https://ah9szoaj9w.ecn.cdn.ofs.kr/images/tvee-admin/content/CS_20240905151009.png"
                                    style="width: 274.267px; height: 368.301px;"></div>
                            <p style="padding-bottom: 15px; white-space: normal; overflow-wrap: break-word;">채운국 이야기 2기
                            </p>
                            <p class="genre"><span>판타지</span><span>15세 관람</span></p>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="div_li"
                            ...
                            <div class="list_img_bg" style="cursor: pointer;"><img
                                    src="https://ah9szoaj9w.ecn.cdn.ofs.kr/images/tvee-admin/content/CS_20240731170432.png"
                                    style="width: 274.267px; height: 368.301px;"></div>
                            <p style="padding-bottom: 15px; white-space: normal; overflow-wrap: break-word;">[극장판] 시티헌터
                                엔젤 더스트
                            </p>
                            <p class="genre"><span>SF/판타지</span><span>19세 관람</span></p>
                        </div>
                    ...
                    <div>
                        <div class="div_li"
                            ...
                            <div class="list_img_bg" style="cursor: pointer;"><img
                                    src="https://ah9szoaj9w.ecn.cdn.ofs.kr/images/tvee-admin/content/CS_20240806172406.jpg"
                                    style="width: 274.267px; height: 368.301px;"></div>
                            <p style="padding-bottom: 15px; white-space: normal; overflow-wrap: break-word;">신의 탑</p>
                            <p class="genre"><span>판타지</span><span>15세 관람</span></p>
                        </div>
                    </div>
                </div>
