...
<div class="aniEdit">
         ...
         <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                          <input type="submit" class="btn btn-outline-success btn-sm" value="애니 수정" style="width:150px; margin-bottom : 20px;">
                      </div>
         <form action="/master/aniEditMasterOk" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
             <div class="mb-3 row">
